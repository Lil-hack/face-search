...
```bash
python train.py --image_dir ~/flower_photos
```
...
```bash
python train.py (... other args as before ...) \
...
def start_train(image_dir,output_graph,output_labels):
...
if __name__ == '__main__':
    ...
    image_dir='/'
    output_graph=os.path.dirname(os.path.abspath(__file__)) + '/gender_model.pb'
    output_labels=os.path.dirname(os.path.abspath(__file__)) + '/gender_label.txt'

    start_train(image_dir,output_graph,output_labels)